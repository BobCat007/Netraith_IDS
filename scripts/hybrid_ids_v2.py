...
hybrid_score = 0.6 * reconstruction_error + 0.4 * iso_preds

threshold = np.percentile(hybrid_score, 70)
...
print("Hybrid score mean:", np.mean(hybrid_score))
print("Hybrid score std:", np.std(hybrid_score))
